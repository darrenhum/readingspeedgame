    ...
    questions: [
      {
        ...
        evidence: [
          'The fictional town of Bellwick will test longer opening hours at its central library for six weeks, beginning on October 7.',
          'The two neighbourhood branches are not part of the trial.',
        ],
      },
      {
        ...
        evidence: [
          'During the trial, librarians will record visits after 6 p.m. and invite visitors to complete an optional survey.',
          'The council will review both sources of information before deciding whether to continue the arrangement.',
        ],
      },
      {
        ...
        evidence: ['A proposal to add Saturday workshops is being considered separately and has no confirmed start date.'],
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        evidence: [
          'Requests for equipment needed before 10 a.m. must be entered by 3 p.m. on the previous working day.',
          'For a Monday morning collection, that means Friday afternoon.',
        ],
      },
      {
        ...
        evidence: ['Existing bookings made in the team chat will be honoured, and reception will transfer them to the calendar; staff should not enter those bookings again.'],
      },
      {
        ...
        evidence: ['If an item is damaged or missing, contact reception instead of marking it returned.'],
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        evidence: [
          'In the card group, 17 of the 20 volunteers returned every borrowed tool on time.',
          'In the verbal-reminder group, 12 of the 20 did so.',
          'The researchers counted volunteers with no late returns, not the total number of tools returned.',
        ],
      },
      {
        ...
        evidence: [
          'Volunteers chose which group to join; they were not assigned at random.',
          'The results suggest that reminder cards may be worth testing further, but they do not establish that the cards caused the difference.',
          'Volunteers who chose cards might already have been more organised.',
        ],
      },
      {
        ...
        evidence: ["The team recommended a larger trial with random assignment before changing the centre's standard borrowing procedure."],
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        evidence: ['For example, an opening reading of 280 cubic metres and a closing reading of 292 cubic metres show use of 12 cubic metres.'],
      },
      {
        ...
        evidence: ['Comparing daily averages is more useful than comparing period totals when two notices cover different numbers of days.'],
      },
      {
        ...
        evidence: [
          'A reading marked E is an estimate, while a reading marked A was actually taken from the meter.',
          'An estimated notice may be adjusted after an actual reading becomes available.',
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        evidence: ['From June 8, the shuttle will use Orchard Road and stop outside the sports hall instead of beside the riverside gate.'],
      },
      {
        ...
        evidence: [
          'Engineers expect the repairs to take three Saturdays.',
          'However, the shuttle will return to Mill Street only after the bridge passes an inspection.',
        ],
      },
      {
        ...
        evidence: ['Tickets will cost the same as before, and passengers will not need to book seats.'],
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        evidence: ['Visitors may take up to two packets per visit without bringing seeds of their own.'],
      },
      {
        ...
        evidence: [
          'Donated packets must be sealed and labelled with the plant name and the year the seeds were collected.',
          'Volunteers will check the labels before placing donations on the stall.',
          'They will not test whether the seeds will sprout, so a checked label is not a guarantee of successful growth.',
        ],
      },
      {
        ...
        evidence: ['The garden association has supplied a cupboard for storing packets between sessions.'],
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        evidence: [
          'Each label must show the department name, a box number, and the destination shelf code.',
          'Record the same details in the shared inventory before sealing the box.',
        ],
      },
      {
        ...
        evidence: [
          'Yellow labels are for files that must remain accessible at reception during the move.',
          'Do not place yellow-labelled boxes on the collection trolley.',
        ],
      },
      {
        ...
        evidence: ['If you cannot find a destination shelf code, leave the box unsealed and ask the archive coordinator; do not guess a code from a neighbouring box.'],
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        evidence: ['Sixty adults visiting for the first time were randomly assigned to receive either the existing map or a simplified version.'],
      },
      {
        ...
        evidence: [
          'The simplified-map group had a median completion time of eight minutes, compared with eleven minutes for the existing-map group.',
          'The median is the middle value when the times are arranged in order; it does not mean that every participant finished within that time.',
        ],
      },
      {
        ...
        evidence: ['Researchers did not ask which map visitors preferred, measure how much they learned from exhibits, or test whether they remembered routes the next day.'],
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        evidence: [
          'At each check, observers recorded whether each bench had at least one person sitting on it.',
          'They did not count the number of people on an occupied bench.',
        ],
      },
      {
        ...
        evidence: [
          'The team noted that the shaded benches were also closer to the pond and farther from the main road.',
          'Because location and shade varied together, the observations could not show which feature explained the difference.',
        ],
      },
      {
        ...
        evidence: ['Staff proposed testing temporary shade over some open benches before recommending permanent structures.'],
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        evidence: [
          'A message marked Confirmed gives the workshop date, start time, and room.',
          'Only a confirmed reservation allows a visitor to attend.',
        ],
      },
      {
        ...
        evidence: ["For example, a place offered at 10 a.m. on Tuesday with a deadline of noon on Wednesday must be accepted by Wednesday noon, not by the workshop's starting time."],
      },
      {
        ...
        evidence: [
          'When someone cancels, staff offer the place to the earliest waiting request for that same session.',
          'If no reply arrives in time, the offer expires and passes to the next request.',
        ],
      },
    ],
  },
